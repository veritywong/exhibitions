class ExhibitionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @exhibition.save
        format.html { redirect_to exhibition_url(@exhibition), notice: "Exhibition was successfully created." }
  ...
  def update
    respond_to do |format|
      if @exhibition.update(exhibition_params)
        format.html { redirect_to exhibition_url(@exhibition), notice: "Exhibition was successfully updated." }
  ...
  private
    ...
    def exhibition_params
      params.require(:exhibition).permit(:title, :start_date, :end_date, :location, :image, :url)
    end
end
